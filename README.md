...
2. 
3. Компьютер, на котором происходит распознавание видеокартинки, сохранение её в отдельный файл, а также ведение счёта игры.
4. 
5. Стол для игры в снукер стандартного размера (366 см х 183 см).
6. 
7. Шары и кии с датчиками касаний. Датчики необходимы для предотвращения касания шаров руками, элементами одежды и прочими предметами.
8. 
9. Монитор (табло) с помощью которого игроки в реальном времени смогут отслеживать текущие результаты игры.
